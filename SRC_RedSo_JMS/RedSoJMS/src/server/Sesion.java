...
public class Sesion extends UnicastRemoteObject implements SesionInterfaz, Serializable, MessageListener {
	...
	public void confirmFriend(String email_1) throws RemoteException {
		...
		session8.getTransaction().commit();
			...
			session12.flush();  // changes to cat are automatically detected and persisted
	...
	public boolean[] getFriendship(String email_objetivo) throws RemoteException {
		/*
		 * Recibe como argumento el email_objetivo que se va a comprobar junto con el email de usuario conectado.
		 * Devuelve un array de booleanos con el siguiente formato: [Registro existente , amistad_confirmada, usuario_confirmado, objetivo_confirmado]
		 * 
		 */
