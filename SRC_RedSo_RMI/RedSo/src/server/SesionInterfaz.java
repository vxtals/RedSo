...
/**
 * Interfaz remota que abstrae el concepto de sesión, permitiendo al cliente asociado a la instancia <br>
...
public interface SesionInterfaz extends Remote {
	 ...
	 * al email pasado como parámetro. Para no ralentizar el sistema crea un thread paralelo que se encarga de notificar <br>
	...
	/**
	 * El usuario del programa cliente invocante confirma su conformidad con la petición de amistad del usuario<br>
	...
	/**
	 * Devuelve un array de booleanos que contiene información sobre el registro de dos usuarios en la tabla Friend. El array <br>
	 * devuelto tiene la siguiente estructura [Existe registro , amistad_confirmada , invocante_acepta , usuario_parámetro_acepta].
	...
	/**
	 * Se crea un registro en la tabla Message con los datos del usuario, el mensaje y la hora al momento de la invocación.<br>
	 * Además crea un thread paralelo encargado de notificar a las aplicaciones cliente mediante callback sin ralentizar el <br>
	 * sistema.
	 * @param mensaje
	 * @throws RemoteException
	 */
	...
	/**
	 * Devuelve una lista iterable de objetos Message cuyo email_ID se corresponda con el pasado como parámetro.
	 * @param email
	 * @return List\<Message\>
	 * @throws RemoteException
	 */
	 ...
	 * Se separa el String recibido como parámetro en palabras, y se compara cada una con el campo email y con el campo apellidos <br>
	...
	/**
	 * Elimina el objeto remoto asociado con un usuario que ha inicado sesión.
	 * @param email
	 * @throws RemoteException
	 */
